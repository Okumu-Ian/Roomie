...
public class Login extends Fragment {
    ...
    private void initUI(){
        //reference views
        email = mView.findViewById(R.id.edt_login_email);
        password = mView.findViewById(R.id.edt_login_password);
        loginButton = mView.findViewById(R.id.btn_login);
        registerText = mView.findViewById(R.id.txt_go_to_register);
